...
export function setHomepageSEO() {
  ...
  setMetaProperty('og:image', `${SITE}/og-image.svg`);
...
export function setAnimeDetailSEO(anime) {
  ...
  setMetaProperty('og:image', anime.coverImage?.large || anime.coverImage?.medium || `${SITE}/og-image.svg`);
  ...
  setMetaProperty('twitter:image', anime.coverImage?.medium || `${SITE}/og-image.svg`);
  ...
  const jsonld = {
    ...
    "image": anime.coverImage?.large || anime.coverImage?.medium || `${SITE}/og-image.svg`,
    "genre": anime.genres || [],
...
export function setWatchSEO(anime, episodeNumber) {
  ...
  const watchUrl = `/watch/${anime.id}-episode-${epNum}`;
  ...
  const jsonld = {
    ...
    "thumbnailUrl": anime.coverImage?.large || anime.coverImage?.medium || `${SITE}/og-image.svg`,
  ...
  const breadcrumb = {
    ...
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": `${SITE}/` },
      { "@type": "ListItem", "position": 2, "name": "Catalog", "item": `${SITE}/catalog` },
      { "@type": "ListItem", "position": 3, "name": title, "item": `${SITE}/anime/${anime.id}` },

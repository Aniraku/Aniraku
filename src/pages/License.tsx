// TS port of Aniraku's src/pages/License.jsx — content kept verbatim in the
// source's own wording (final brand: Aniraku); repository URL restored.
...
const License = () => {
  ...
  useSeo({
    title: 'AGPL-3.0 License | Aniraku',
    description:
      'Aniraku is free software under the GNU AGPL-3.0 — what the license permits, how network use applies, and third-party notices.',
    canonicalPath: '/license',
    jsonLd: breadcrumbLd('Open Source License', '/license'),
  });

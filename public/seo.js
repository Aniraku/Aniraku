...
(function(){
  ...
  var SITE = IS_LOCAL ? 'http://localhost:3000' : 'https://aniraku.vercel.app';
  ...
  function updateMetaUrls() {
    document.querySelectorAll('[id$="-url"],[id$="-image"]').forEach(function(e) {
      var val = e.content || '';
      if (val.startsWith('https://aniraku.vercel.app') || val.startsWith(SITE)) {
        e.content = val.replace('https://aniraku.vercel.app', SITE);
      }
    });
  }

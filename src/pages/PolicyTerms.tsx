...
const sections = [
  {
    ...
    content: (
      <Paragraph>
        ...
        for the functioning of Aniraku, such as account information and user
        preferences.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <strong>Cookies and Tracking</strong>: Aniraku uses cookies and similar
        ...
        <StyledLink href='mailto:sho.islam0311@proton.me'>
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        <strong>Acceptance of Terms</strong>: By using Aniraku, you agree to
        these Terms of Service and acknowledge that they affect your legal
        rights and obligations.
        <br></br>
        <br></br>
        <strong>Content</strong>: Aniraku does not host video content but embeds
        ...
        of the embedded videos remain with their respective owners. Aniraku
...
function PolicyTerms() {
  ...
  useEffect(() => {
    document.title = 'Policy & Terms · Aniraku';
  }, []);
  return (
    <SplashContainer>
      <MainContent>

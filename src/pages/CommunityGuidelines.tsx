// TS port of Aniraku's src/pages/CommunityGuidelines.jsx — content kept
// verbatim in the source's own wording (final brand: Aniraku); GitHub issue
// link restored.
...
const CommunityGuidelines = () => {
  ...
  useSeo({
    title: 'Community Guidelines | Aniraku',
    description:
      'Community guidelines for Aniraku — how to take part in comments, replies, profiles, and ratings, what is not allowed, and how reports work.',
    canonicalPath: '/community-guidelines',
    jsonLd: breadcrumbLd('Community Guidelines', '/community-guidelines'),
  });

// TS port of Aniraku's src/pages/Dmca.jsx — content kept verbatim in the
// source's own wording (final brand: Aniraku); GitHub issue link restored.
...
const Dmca = () => {
  ...
  useSeo({
    title: 'Copyright & DMCA Notices | Aniraku',
    description:
      'Copyright and DMCA notices for Aniraku — how to submit a copyright concern or community-content report, and how reviews and counter-notices work.',
    canonicalPath: '/dmca',
    jsonLd: breadcrumbLd('Copyright & DMCA', '/dmca'),
  });
  ...
  return (
    ...
    >
      ...
      <p>Aniraku is an open-source discovery and playback client. It uses third-party metadata and source-resolution paths; it does not intentionally host or maintain a permanent library of episode files on Aniraku servers. We cannot delete a file from an unrelated third-party host through a Aniraku notice.</p>
      ...
      <p>We may acknowledge receipt, request missing information, compare the report with the relevant project data, and take proportionate action. Possible actions include correcting or hiding a metadata link, restricting a resolver path, removing community content, or explaining why the reported material is not controlled by Aniraku. A notice sent to this inbox is not automatically a notice to a third-party provider or a substitute for that provider’s own reporting process.</p>
      ...
      <p>If a Aniraku-controlled page or community item was restricted in error, you may reply with the specific material, the reason you believe the action was mistaken, your contact information, and any statement or signature required by the law that applies to your situation. A counter-notice may be shared with the reporting party where required or appropriate. A formal DMCA counter-notice can carry legal consequences, so obtain qualified legal advice before submitting one.</p>
